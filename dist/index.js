import { Group, sleep } from "async-monitor.js";
...
function demo_serial_execution() {
    ...
    console.log(`└──┬function_to_watch1()}`);
    console.log(`   └──┬function_to_watch2()`);
    console.log(`      └──function_to_watch3()`);
    serialWatches.reset();
    serialWatches.WatchAll(() => {
        console.table(serialWatches._functions.map((el, i) => {
            return {
                index: i,
